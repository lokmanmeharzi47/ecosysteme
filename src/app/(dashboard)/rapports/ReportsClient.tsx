...
export interface Report {
 ...
 period: string;
 formats: string[];
 status: 'Terminé' | 'Généré' | 'En cours';
}

export default function ReportsClient({ recentReports, stats }: { recentReports: Report[], stats: any }) {
   ...
   <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-sm flex items-center justify-between">
     <div className="space-y-1">
      ...
      <div className="text-2xl font-black text-neutral-850">{stats.successRate}%</div>
     </div>
     <div className="w-9 h-9 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600">
      ...
      return (
       ...
       >
        <div>
         ...
         <p className="text-[10px] text-neutral-450 leading-relaxed font-semibold mb-6">
          {template.desc}
         </p>
        </div>
   ...
   <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div className="lg:col-span-2 bg-white border border-neutral-200 rounded-2xl p-5 shadow-sm space-y-4">
     <div className="flex items-center justify-between border-b border-neutral-100 pb-3">
      <h3 className="font-bold text-neutral-800 text-sm">Rapports récents</h3>
       ...
       <tbody>
        {recentReports.map(report => (
         <tr key={report.id} className="border-b border-neutral-150 last:border-0 hover:bg-neutral-50/50 transition-colors">
          ...
          <td className="p-3 font-semibold text-neutral-600">{report.site}</td>
          <td className="p-3 font-semibold text-neutral-400">{report.period}</td>
          <td className="p-3">
           <div className="flex gap-1">
            {report.formats.map(fmt => (
             <span key={fmt} className={`text-[8px] font-black border px-1 rounded ${fmt === 'PDF' ? 'bg-red-50 text-red-600 border-red-200' : 'bg-emerald-50 text-emerald-600 border-emerald-200'}`}>
              {fmt}
             </span>
            ))}
           </div>
    ...
    <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-sm space-y-4">
     <div className="flex items-center justify-between border-b border-neutral-100 pb-3">
      <h3 className="font-bold text-neutral-800 text-sm">Envois automatiques</h3>
     ...
     <div className="space-y-3">
      ...
      <div className="p-3 border border-neutral-150 rounded-xl flex items-center justify-between gap-3 bg-neutral-50/30">
       <div className="flex items-center gap-2.5">
        ...
        <div>
         <h4 className="font-bold text-neutral-800">Hebdo - Environnement</h4>
      ...
      <div className="p-3 border border-neutral-150 rounded-xl flex items-center justify-between gap-3 bg-neutral-50/30">
       <div className="flex items-center gap-2.5">
        ...
        <div>
         <h4 className="font-bold text-neutral-800">Mensuel - Consommation</h4>
      ...
      <div className="p-3 border border-neutral-150 rounded-xl flex items-center justify-between gap-3 bg-neutral-50/30">
       <div className="flex items-center gap-2.5 opacity-60">
        ...
        <div>
         <h4 className="font-bold text-neutral-800">Quotidien - Alertes</h4>
