    ...
    FOR i IN 1..25 LOOP
        ...
        VALUES (
            ...
            json_build_object('first_name', 'User', 'last_name', i::TEXT, 'system_role', 
                CASE 
                    WHEN i = 1 THEN 'super_admin'
                    WHEN i <= 5 THEN 'organization_manager'
                    WHEN i <= 15 THEN 'environmental_engineer'
                    ELSE 'technician'
                END
            )
        );
        ...
        VALUES (
            ...
            user_id,
            CASE 
                WHEN i = 1 THEN 'super_admin'::user_role
                WHEN i <= 5 THEN 'organization_manager'::user_role
                WHEN i <= 15 THEN 'environmental_engineer'::user_role
